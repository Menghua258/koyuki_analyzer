...
class BaseMod:
    ...
    def _get_resource_paths(self):
        """获取模组资源路径"""
        mod_base = os.path.join(BASE_DIR, "appdata", "mods", self.mod_name)
...
class ModManager:
    ...
    def _scan_available_mods(self):
        ...
        mods_dir = os.path.join(BASE_DIR, "appdata", "mods")
        scripts_dir_new = os.path.join(BASE_DIR, "appdata", "mods")
    ...
    def _load_mod_script(self, mod_name):
        ...
        try:
            mod_script_dir = os.path.join(BASE_DIR, "appdata", "mods", mod_name, "mod_script")
