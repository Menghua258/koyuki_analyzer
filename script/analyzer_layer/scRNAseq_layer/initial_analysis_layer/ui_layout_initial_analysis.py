...
class InitialAnalysisPageUI:
    ...
    def update_styles(self):
        ...
        for child in self.analysis_page.findChildren(QPushButton):
            ...
            if child in [self.btn_select_path, self.btn_load]:
                continue  # 导入按钮保持import_button样式
            elif child == self.btn_query:
    ...
    def create_page(self):
        ...
        self.btn_back_analysis = create_styled_button("← 返回主页", font_size=12)
        ...
        self.btn_select_path = create_styled_button("扫描数据路径", font_size=12, button_type='import')
        left_layout.addWidget(self.btn_select_path)
        
        self.h5ad_combo = create_styled_combo_box()
        left_layout.addWidget(self.h5ad_combo)
        
        self.btn_load = create_styled_button("加载数据集", font_size=12, button_type='import')
