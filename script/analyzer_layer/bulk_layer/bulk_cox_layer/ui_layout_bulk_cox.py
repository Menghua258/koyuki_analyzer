...
class BulkCoxPageUI:
    ...
    def create_page(self):
        ...
        self.btn_back_bulk_cox = create_styled_button("← 返回主页", font_size=12)
        top_layout.addWidget(self.btn_back_bulk_cox)

        title_label = QLabel("bulk Cox分析")
        ...
        self.music_controller = MusicControllerClass(self.bulk_cox_page, mod_instance)
