...
class BulkKmRPageUI:
    ...
    def update_background(self):
        ...
        paths = get_mod_paths()
        bg_label = self.bulk_km_r_page.findChild(QLabel, "bulk_km_r_bg")
        if bg_label:
    ...
    def update_styles(self):
        ...
        overlay = self.bulk_km_r_page.findChild(QWidget, "bulk_km_r_overlay")
        if overlay:
    ...
    def create_page(self):
        ...
        bg_label = QLabel(self.bulk_km_r_page)
        bg_label.setObjectName("bulk_km_r_bg")
        ...
        overlay = QWidget(self.bulk_km_r_page)
        overlay.setObjectName("bulk_km_r_overlay")
        ...
        self.btn_back = create_styled_button("← 返回KM模式", font_size=12)
        top_layout.addWidget(self.btn_back)

        title_label = QLabel("bulk KM曲线 R模式")
